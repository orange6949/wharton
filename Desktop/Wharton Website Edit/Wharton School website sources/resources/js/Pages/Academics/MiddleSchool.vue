        ...
        <div class="subContent area-courses">
            <div class="wrap">
                ...
                <div class="m-boards type01">
                    ...
                    <div class="m-empty type01" v-if="courses.data.length === 0" data-aos-duration="1500" data-aos="fade-up">
                        There is no data.
                    </div>
                </div>
...
export default {
    ...
    methods: {
        filter() {
            this.params.get("/academics/middleSchool", {
                preserveScroll: true,
            });
        },
